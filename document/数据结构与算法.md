...
- BF算法，RK算法，BM算法，KMP算法 都是单模式串匹配算法
- Trie树是多模式串匹配算法

**单模式匹配算法：**

​	是一个模式串和主串之间的比较，也就是在一个主串中查找一个模式串

**多模式匹配算法：**

​	多个模式串和一个主串之间做匹配，也就是在一个主串中查找多个模式串
...
<img src="image/dataStructure/动态规划0-1背包问题.jpg" alt="img" style="zoom: 67%;" />

<img src="image/dataStructure/动态规划0-1背包问题1.jpg" alt="img" style="zoom:67%;" />
 ...
 * 优化空间使用率  使用一维数组实现
 *
 * 使用一维数组记录当前计算过的重量，如果下一个物品想要放置到背包中，则需要数组中的重量为true才可以放置
 * 相当于叠加重量，最后最大的重量就是最优解
 */
...
<img src="image/dataStructure/杨辉三角改编版.jpg" alt="img" style="zoom:67%;" />
...
它指的是动态规划适合解决的问题的模型。这个模型定义为“多阶段决策最优解模型”。
